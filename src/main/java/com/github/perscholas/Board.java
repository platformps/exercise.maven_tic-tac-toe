...
public class Board {
    ...
    public boolean isInFavorOf(char XO){
        //checking all row values
        if (board[0][0].equals(XO) && board[0][1].equals(XO) && board[0][2].equals(XO))
            return true;
        else if(board[1][0].equals(XO) && board[1][1].equals(XO) && board[1][2].equals(XO))
            return true;
        else if (board[2][0].equals(XO) && board[2][1].equals(XO) && board[2][2].equals(XO))
            return true;
        //checking all column values
